...
fig_width_2 = 655;% spacetime
fig_width_3 = 700;% Proportion
...
try 
    l=legend(legend_text ,'Location','eastoutside','Interpreter','latex',Direction='normal');
catch
    l=legend(legend_text ,'Location','eastoutside','Interpreter','latex');
end
